        ...
        <div id="popUp" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 px-4">
            <div class="relative w-full max-w-[374px] rounded-lg bg-white p-6 text-center">
                ...
                <div class="mt-6 flex justify-center gap-4">
                    ...
                    <a href="{{ route("auth.psikotes-paid.register") }}" class="flex h-[45px] w-[145px] items-center justify-center rounded-xl border-2 bg-gradient-to-r from-[#3986A3] to-[#15323D] font-plusJakartaSans text-lg font-semibold text-white">Daftar</a>
                </div>
            </div>
        </div>
    </div>
