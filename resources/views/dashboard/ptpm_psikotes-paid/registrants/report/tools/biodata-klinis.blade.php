    ...
    <body>
        ...
        <div class="section">
            ...
            <div class="info-grid1">
                <div class="left-section">
                    <div class="info-item">
                        <p class="label">Nama Suami/Istri</p>
                        <p class="value">Udayana Warmadewa</p>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <p class="value">Pegawai Negeri Sipil</p>
                    </div>
                </div>
                ...
                <div class="right-section">
                    ...
                    <div class="info-item">
                        <p class="label">Suku Bangsa</p>
                        <p class="value">Bali</p>
                    </div>
                    <div class="info-item">
                        <p class="label">Alamat</p>
                        <p class="value">Jalan I Gusti Ngurah Rai</p>
        ...
        <!-- Section Ayah -->
        <div class="section">
            <h2 class="section-title">Ayah</h2>
            <div class="info-grid1">
                <div class="left-section">
                    <div class="info-item">
                        <p class="label">Nama Ayah</p>
                        <p class="value">Udayana Warmadewa</p>
                    </div>
                    <div class="info-item">
                        <p class="label">Jenis Kelamin</p>
                ...
                <div class="right-section">
                    <div class="info-item">
                        <p class="label">Status Anggota Keluarga</p>
                        <p class="value">Kandung</p>
                    </div>
                    <div class="info-item">
                        <p class="label">Usia</p>
                        <p class="value">50</p>
        ...
        <div class="section">
            ...
            <div class="info-grid1">
                <div class="left-section">
                    <div class="info-item">
                        <p class="label">Nama Ibu</p>
                        <p class="value">Mahendradatta Gunapriya Dharmapatni</p>
                    </div>
                    <div class="info-item">
                        <p class="label">Jenis Kelamin</p>
                        <p class="value">Perempuan</p>
