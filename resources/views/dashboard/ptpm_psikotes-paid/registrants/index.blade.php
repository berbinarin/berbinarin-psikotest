                            ...
                            @foreach ($registrants as $registrant)
                                <tr id="" class="data-consume">
                                    ...
                                    <td class="flex items-center justify-center gap-2">
                                        <a href="{{ route("dashboard.registrants.show", $registrant->id) }}" class="inline-flex items-start justify-start rounded p-2 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2" style="background-color: #3b82f6">
