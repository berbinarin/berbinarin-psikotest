            ...
            <div>
                <div class="flex items-center gap-2">
                    ...
                    <p tabindex="0"
                        ...
                        Tambah Data Pendaftar</p>
                </div>
                <p class="text-gray-500 py-2">Fitur ini menambah data pengguna seperti nama, jenis kelamin, tanggal lahir,
                    dan email yang telah mengisi psikotes Berbinar.</p>
            </div>
        </div>

        {{-- Wrapper Alpine.js --}}
        <div class="flex flex-col gap-10 rounded-[24px] bg-white mb-7 shadow px-10 pt-7 pb-10 mb-7" x-data="{
            ...
            <form action="{{ route('dashboard.registrants.store') }}" method="POST" class="flex flex-col gap-10">
                ...
                <div class="flex gap-20">
                    <div class="flex w-full flex-col">
                        <label for="birthdate" class="mb-2 font-bold text-[#9b9b9b]">Tanggal Lahir</label>
                        <input type="date" name="date_of_birth" id="birthdate"
                    ...
                    <div class="flex w-full flex-col">
                        ...
                        <input type="number" id="age" name="age"
                            class="rounded-md border-1 border-gray-300 px-6 py-3 text-sm font-semibold drop-shadow-[0_1px_4px_rgba(0,0,0,0.16)] focus:ring-0"
                            placeholder="Umur Sekarang" value="{{ old('age') }}" readonly />
                    </div>
                </div>
                <div class="flex gap-20">
                    <div class="flex w-full flex-col">
                        ...
                        <input type="email" id="email" name="email"
                            class="rounded-md border-1 border-gray-300 px-6 py-3 text-sm font-semibold drop-shadow-[0_1px_4px_rgba(0,0,0,0.16)] focus:ring-0"
                            placeholder="Berbinar@gmail.com" value="{{ old('email') }}" />
                    </div>
                    <div class="flex w-full flex-col">
                        <label for="phone_number" class="mb-2 font-bold text-[#9b9b9b]">Telepon</label>
                        <input type="tel" id="phone_number" name="phone_number"
                            class="rounded-md border-1 border-gray-300 px-6 py-3 text-sm font-semibold drop-shadow-[0_1px_4px_rgba(0,0,0,0.16)] focus:ring-0"
                            placeholder="Nomor Telepon Aktif" value="{{ old('phone_number') }}" />
                    </div>
                </div>
                <div class="flex gap-20">
                    <div class="flex w-full flex-col">
                        <label for="test_category_id" class="mb-2 font-bold text-[#9b9b9b]">Kategori Psikotes</label>
                        <select name="test_category_id" id="test_category_id" x-model="selectedCategory"
                            @change="filterTypes()"
                            class="rounded-md border-1 border-gray-300 px-6 py-3 text-sm font-semibold drop-shadow-[0_1px_4px_rgba(0,0,0,0.16)] focus:ring-0">
                    ...
                    <div class="flex w-full flex-col">
                        ...
                        <select name="test_type_id" id="test_type_id" x-model="selectedTestType"
                            :disabled="!selectedCategory || filteredTestTypes.length === 0"
                            class="rounded-md border-1 border-gray-300 px-6 py-3 text-sm font-semibold drop-shadow-[0_1px_4px_rgba(0,0,0,0.16)] focus:ring-0">
                ...
                <div class="flex gap-20">
                    <div class="flex w-full flex-col">
                        ...
                        <select name="psikotes_service" id="psikotes_service"
                            class="rounded-md border-1 border-gray-300 px-6 py-3 text-sm font-semibold drop-shadow-[0_1px_4px_rgba(0,0,0,0.16)] focus:ring-0">
                    ...
                    <div class="flex w-full flex-col">
                        ...
                        <input type="text" id="domicile" name="domicile"
                            class="rounded-md border-1 border-gray-300 px-6 py-3 text-sm font-semibold drop-shadow-[0_1px_4px_rgba(0,0,0,0.16)] focus:ring-0"
                            placeholder="Domisili" value="{{ old('domicile') }}" />
                    </div>
                </div>
                <div class="flex gap-20">
                    <div class="flex w-full flex-col">
                        ...
                        <textarea id="reason" name="reason" rows="10"
                            class="rounded-md border-1 border-gray-300 px-6 py-3 text-sm font-semibold drop-shadow-[0_1px_4px_rgba(0,0,0,0.16)] focus:ring-0"
                            placeholder="Tuliskan Alasan Di Sini">{{ old('reason') }}</textarea>
                    </div>
                </div>
