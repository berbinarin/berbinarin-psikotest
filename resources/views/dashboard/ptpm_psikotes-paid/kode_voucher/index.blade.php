                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="flex flex-row justify-center gap-2">
                                            ...
                                            <a href="{{ route('dashboard.kode-voucher.edit', $voucher->id) }}" class="inline-flex items-start justify-start p-3 bg-yellow-500 hover:bg-yellow-600 rounded">
...
@section("script")
    <script>
        ...
        function openDeleteModal(voucherId) {
            deleteForm.action = `/dashboard/kode-voucher/${voucherId}`;
