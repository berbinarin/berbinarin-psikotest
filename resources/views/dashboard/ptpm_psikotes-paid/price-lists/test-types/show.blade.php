    ...
    <section class="flex w-full">
        <div class="w-full">
            <div class="py-4 md:pb-7 md:pt-12">
                <div>
                    <p tabindex="0" class="mb-2 text-base font-bold leading-normal text-gray-800 focus:outline-none sm:text-lg md:text-2xl lg:text-4xl">Data Jenis Psikotes</p>
            ...
            <div class="rounded-[24px] bg-white px-10 py-7">
                <div class="mt-4 overflow-x-auto">
                    <table id="table" class="display gap-3" style="overflow-x: scroll">
                        ...
                        <tbody>
                            @foreach ($testCategory->testTypes as $type)
                                <tr id="" class="data-consume">
                                    ...
                                    <td class="flex items-center justify-center gap-2">
                                        <a href="{{ route('dashboard.test-types.show', $type->id) }}" class="mt-4 inline-flex items-start justify-start rounded p-3 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:mt-0">
