<div class="w-full p-6 bg-gray-50">
    ...
    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-6">
        <div class="group bg-white w-full rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-blue-200">
            <div class="p-4 flex gap-6 w-full">
                @foreach ($attempt->responses as $data)
                    @php
                    ...
                    <div class="relative mb-4 w-1/2">
                        @if($imagePath)
                            <button
                                type="button"
                                class="w-full h-64 md:h-72 lg:h-80 bg-gray-100 rounded-lg overflow-hidden relative group/image p-0 border-0 openImageBtn"
