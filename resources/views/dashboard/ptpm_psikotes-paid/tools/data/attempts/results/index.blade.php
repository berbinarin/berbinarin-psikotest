                ...
                <div class="py-4 md:pb-7 md:pt-12">
                    <div>
                        <div class="mb-2 flex items-center gap-2">
                            ...
                            <p tabindex="0" class="text-base font-bold leading-normal text-gray-800 focus:outline-none sm:text-lg md:text-2xl lg:text-4xl">Detail Jawaban Alat Tes {{$tool->name}}</p>
                        </div>
