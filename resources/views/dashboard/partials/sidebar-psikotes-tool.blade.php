<nav class="flex w-56 flex-col items-center bg-white py-8 pl-10 pr-6">
    ...
    <ul class="mt-10 text-gray-700 dark:text-gray-400">
        ...
        <li class="dark-hover:text-blue-300 mt-1 rounded-lg p-2">
            <a href="{{ route("dashboard.psikotes-tools.data.index", $psikotesTool->id) }}" class="{{ isRouteNameStartWith("dashboard.psikotes-tools.data.index") }} flex flex-row items-center text-gray-700 duration-700 hover:text-primary">
        ...
        <li class="my-5 rounded-lg p-2">
            <a href="{{ route('dashboard.psikotes-tools.data.data', $psikotesTool->id) }}" class="{{ isRouteNameStartWith("dashboard.psikotes-tools.data.data") }} flex flex-row items-center text-gray-700 duration-700 hover:text-primary">
        ...
        <li class="my-5 rounded-lg p-2">
            <a href="{{ route('dashboard.psikotes-tools.data.sections', $psikotesTool->id) }}" class="{{ isRouteNameStartWith("dashboard.psikotes-tools.data.questions") }} flex flex-row items-center text-gray-700 duration-700 hover:text-primary">
                <i class="bx bx-receipt mr-2 text-lg text-gray-700"></i>
        ...
        <li class="dark-hover:text-blue-300 mt-20 rounded-lg p-2">
            <a href="{{ route('dashboard.psikotes-tools.index') }}" class="fixed bottom-5 left-14 items-center gap-2 rounded-full bg-blue-500 px-6 py-2 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300">
