...
<li class="my-5 rounded-lg p-2">
    <a href="{{ route('dashboard.psikotes-tools.index') }}" class="{{ isRouteNameStartWith('dashboard.psikotes-tools') }} flex flex-row items-center text-gray-700 duration-700 hover:text-primary">
