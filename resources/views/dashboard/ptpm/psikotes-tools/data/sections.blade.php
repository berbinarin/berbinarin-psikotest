@extends(
    ...
    [
        "title" => "Jawaban" . $psikotesTool->name,
    ]
)
        ...
        <div class="flex w-full flex-col">
            <div class="w-full">
                <div class="py-4 md:pb-7 md:pt-12">
                    <div>
                        <p tabindex="0" class="mb-2 text-base font-bold leading-normal text-gray-800 focus:outline-none sm:text-lg md:text-2xl lg:text-4xl">Daftar Section Alat Test {{ $psikotesTool->name }}</p>
                ...
                <div class="rounded-md bg-white px-4 py-4 md:px-8 md:py-7 xl:px-10">
                    <div class="mt-4 overflow-x-auto">
                        <table id="example" class="display w-full" style="overflow-x: scroll">
                            ...
                            <tbody>
                                @foreach ($psikotesTool->sections as $section)
                                    <tr class="data-consume">
                                        ...
                                        <td class="whitespace-no-wrap px-6 py-4 text-center">
                                            <a href="{{ route("dashboard.psikotes-tools.data.section.questions", [$psikotesTool->id, $section->id]) }}" class="mt-4 inline-flex items-start justify-start rounded bg-blue-500 p-3 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:mt-0">
