                                ...
                                @foreach ($tools as $tool)
                                    <tr id="" class="data-consume">
                                        ...
                                        <td class="flex justify-center gap-2">
                                            {{-- GENERATE TOKEN --}}
                                            <form action="{{ route("dashboard.psikotes-tools.generate_token", $tool->id) }}" method="POST" style="display: inline-block">
                                                @csrf
                                                <button type="submit" class="mt-0 inline-flex items-start justify-start rounded-3xl bg-blue-500 p-3 hover:bg-blue-500 focus:ring-2 focus:ring-offset-2">
                                        ...
                                        <td class="justify-center gap-2">
                                            <a href="{{ route("dashboard.psikotes-tools.data.index", $tool->id) }}" class="mt-0 inline-flex items-start justify-start rounded-3xl bg-green-500 p-3 hover:bg-green-500 focus:ring-2 focus:ring-offset-2">
