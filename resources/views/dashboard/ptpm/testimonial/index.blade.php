                            ...
                            <tbody>
                                @foreach ($testimonial as $testi)
                                    <tr id="" class="data-consume">
                                        ...
                                        <td class="text-center">{{ $testi->userPsikotestPaid ? $testi->userPsikotestPaid->name : 'User tidak ditemukan' }}</td>
                                        <td class="text-center">{{ $testi->userPsikotestPaid ? $testi->userPsikotestPaid->email : '-' }}</td>
                                        ...
                                        <td class="flex gap-5 justify-center">
                                            {{-- BUTTON TESTIMONI --}}
                                            <a href="{{ route('dashboard.testimonial.show', $testi->id) }}"
