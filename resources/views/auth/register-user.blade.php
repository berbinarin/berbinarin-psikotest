            ...
            <div id="modal" class="fixed inset-0 -top-6 z-30 flex hidden items-center justify-center bg-gray-900 bg-opacity-50 backdrop-blur-md max-sm:-top-2">
                <div class="h-auto max-h-screen w-[70%] overflow-y-auto rounded-2xl bg-white p-6 shadow-md max-lg:h-[90%] max-sm:w-[86%] max-sm:px-2">
                    ...
                    <div class="mb-6">
                        ...
                        <ol class="mt-1 list-decimal space-y-1 pl-7">
                            <li class="max-sm:text-sm">Tidak membalas pesan admin dalam 1x24 jam, pendaftaran oleh klien secara otomatis dibatalkan.</li>
                            <li class="max-sm:text-sm">Tidak membalas pesan admin dalam 1x24 jam, jadwal yang sudah ditentukan oleh klien berhak untuk diubah oleh Tim Berbinar dan kesepakatan dari klien.</li>
                            <li class="max-sm:text-sm">Tidak membalas pesan admin dalam 2x24 jam setelah melakukan pembayaran, pembayaran dianggap hangus.</li>
                        </ol>
                    </div>
