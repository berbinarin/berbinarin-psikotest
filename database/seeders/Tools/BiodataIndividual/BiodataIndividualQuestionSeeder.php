...
class BiodataIndividualQuestionSeeder extends Seeder
{
    ...
    {
        $biodataIndividual = Tool::with('sections')->firstWhere('name', 'Biodata Individual');

        $questions = [
            [
                'section_id' => $biodataIndividual->sections[0]->id,
                'order' => 1,
                'text' => 'Data Diri',
                'type' => 'form',
                'options' => [
            ...
            [
                ...
                'order' => 12,
                'type' => 'essay',
                'text' => 'Sebutkan tujuan karier Anda di perusahaan',
            ],
            [
                'section_id' => $biodataIndividual->sections[0]->id,
                'order' => 13,
                'type' => 'essay',
                'text' => 'Bagaimana langkah untuk mencapai tujuan tersebut:',
            ],
        ];
